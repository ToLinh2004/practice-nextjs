...
export default function UpdateProductModal(props: IProps) {
  ...
  useEffect(() => {
    if (product && product.id) {
      setId(product.id), setName(product.name), setImageFile(product.img), setPrice(product.price), setQuantity(product.quantity);
    }
  }, [product]);
        ...
        <Modal.Body>
          <Form>
            ...
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
              ...
              <Form.Control type="text" placeholder="Enter URL of image" value={img} onChange={(e) => setImageFile(e.target.value)} />
            </Form.Group>
            ...
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
              ...
              <Form.Control type="number" placeholder="Enter price" value={price} onChange={(e: any) => setPrice(e.target.value)} />
            </Form.Group>
            ...
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
              ...
              <Form.Control type="number" placeholder="Enter Quantity" value={quantity} onChange={(e: any) => setQuantity(e.target.value)} />
            </Form.Group>
